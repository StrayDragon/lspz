...
- [docs/specs/002-compression-format.md](docs/specs/002-compression-format.md) — 压缩格式
...
- [docs/specs/005-toon-format.md](docs/specs/005-toon-format.md) — TOON 格式

### 开发指南
- [AGENTS.md](AGENTS.md) — 项目规范 SSOT
- [docs/guides/agent-integration.md](docs/guides/agent-integration.md) — Agent SDK 集成
- [docs/guides/claude-desktop-integration.md](docs/guides/claude-desktop-integration.md) — Claude Desktop 配置

### 自动生成文档 (禁止手工编辑)
- [docs/api/*.gen.md](docs/api/) — API 文档
- [docs/reference/config.gen.md](docs/reference/config.gen.md) — 配置参考
- [docs/reference/error-types.gen.md](docs/reference/error-types.gen.md) — 错误类型
- [docs/specs/interceptors.gen.md](docs/specs/interceptors.gen.md) — 拦截器列表

### 报告
- [docs/reports/latest.md](docs/reports/latest.md) — 压缩基准报告
